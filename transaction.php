...
<head>
    <title>Alcool Store - Transaction</title>
    <meta charset="utf-8">
            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate mb-5 text-center">
                    <p class="breadcrumbs mb-0"><span class="mr-2"><a href="accueil.php">Accueil <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Transaction <i
                                class="fa fa-chevron-right"></i></span></p>
                    <h2 class="mb-0 bread">Transaction</h2>
                </div>
            </div>
        </div>
    </section>
                   ...
                   <h3 class="mb-4 billing-heading">Combien souhaitez-vous proposer ?</h3>
                    ...
                    <form action="compte.php" class="billing-form" method="post">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-12">
                                <p><button type="submit" name="button9" class="btn btn-primary py-3 px-4">Soumettre</button></p>
